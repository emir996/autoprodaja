    	...
    	<div class="wrapper">
        	...
        	<main id="mainFull">
                ...
                <div class="contactInfo">
                    <p><i class="fa fa-2x fa-phone"></i> 000.000.000.000</p>
                    <p><i class="fa fa-2x fa-envelope"></i>volkswagen@gmail.rs</p>
                    <p><i class="fa fa-2x fa-globe"></i>www.volkswagen.rs</p>
                    <p><i class="fa fa-2x fa-home"></i>22.oktobar 19, 11080 Zemun, Beograd, Serbia</p>
                </div>
